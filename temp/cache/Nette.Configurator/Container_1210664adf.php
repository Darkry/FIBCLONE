<?php
// source: C:\xampp\htdocs\partyGame\app/config/config.neon 
// source: C:\xampp\htdocs\partyGame\app/config/config.local.neon 

class Container_1210664adf extends Nette\DI\Container
{
	protected $meta = array(
		'types' => array(
			...
			'App\Model\GameManager' => array(1 => array('26_App_Model_GameManager')),
			...
			'App\Presenters\GamePrepPresenter' => array(array('application.3')),
		...
		'services' => array(
			...
			'26_App_Model_GameManager' => 'App\Model\GameManager',
			'application.1' => 'App\Presenters\Error4xxPresenter',
			'application.2' => 'App\Presenters\ErrorPresenter',
			'application.3' => 'App\Presenters\GamePrepPresenter',
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => 'C:\xampp\htdocs\partyGame\app',
			'wwwDir' => 'C:\xampp\htdocs\partyGame',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'environment' => 'development',
			'consoleMode' => FALSE,
			'container' => array('class' => NULL, 'parent' => NULL),
			'tempDir' => 'C:\xampp\htdocs\partyGame\app/../temp',
		));
	}
	...
	/**
	 * @return App\Model\GameManager
	 */
	public function createService__26_App_Model_GameManager()
	{
		$service = new App\Model\GameManager($this->getService('database.default.context'));
		return $service;
	}
	...
	/**
	 * @return App\Presenters\GamePrepPresenter
	 */
	public function createServiceApplication__3()
	{
		$service = new App\Presenters\GamePrepPresenter;
		$service->injectPrimary($this, $this->getService('application.presenterFactory'), $this->getService('routing.router'),
			$this->getService('http.request'), $this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->gameDb = $this->getService('26_App_Model_GameManager');
		$service->invalidLinkMode = 5;
		return $service;
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\xampp\htdocs\partyGame\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('C:\xampp\htdocs\partyGame\app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\xampp\htdocs\partyGame\app/../temp/cache', $this->getService('cache.journal'));
		return $service;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=localhost;dbname=Fibbage', 'root', NULL, array('lazy' => TRUE));
	...
	{
		return new Container_1210664adf_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	public function createServiceNette__latte()
	{
		...
		trigger_error('Service nette.latte is deprecated, implement Nette\Bridges\ApplicationLatte\ILatteFactory.',
			16384);
		$service->setTempDirectory('C:\xampp\htdocs\partyGame\app/../temp/cache/latte');
...
final class Container_1210664adf_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_1210664adf $container)
	{
